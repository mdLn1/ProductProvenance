...
import com.example.productprovenance.AccountsActivity;
...
//                jsonParse();
            ...
            default:
                ...
                reqBody = null;
                reqType = Constants.GET_REQUEST;
                RequestController.getInstance().makeRequest(this, Constants.ROUTE_DEFAULT + link, Constants.GET_REQUEST, Constants.GET_TEST_RESPONSE, null, this);
//                jsonParse();
        }
